...
public class User extends TableImpl<UserRecord> {
    ...
    public List<Index> getIndexes() {
        return Arrays.<Index>asList(Indexes.PRIMARY_KEY_27, Indexes.UK_OSO07PUDW19E66BS4YP8HWPUX_INDEX_2);
    }
    ...
    public List<UniqueKey<UserRecord>> getKeys() {
        return Arrays.<UniqueKey<UserRecord>>asList(Keys.CONSTRAINT_27, Keys.UK_OSO07PUDW19E66BS4YP8HWPUX);
    }
